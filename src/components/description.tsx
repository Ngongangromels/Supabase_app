    ...
    return (
        <div>
            {isDesktopOrMobile ? (
                ...
                style={{ backgroundImage: `url(https://image.tmdb.org/t/p/original${description?.backdrop_path})`, backgroundSize: 'cover', height: '100%', width: '100%', margin: '0', padding: '0', position:'fixed', }}
                >
                {description ? (
